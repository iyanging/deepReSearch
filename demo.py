...
async def main(
    ...
    config = Config(
        ...
        planner_max_fetch_count_of_original_question_documents=20,
        planner_max_valid_count_of_original_question_documents=5,
        planner_max_fetch_count_of_original_keywords_documents=20,
        planner_max_valid_count_of_original_keywords_documents=5,
        planner_max_fetch_count_of_translated_keywords_documents=20,
        planner_max_valid_count_of_translated_keywords_documents=5,
        planner_max_retries_of_searching_internet=3,
        planner_max_concurrency_of_checking_document_validity=7,
        planner_max_concurrency_of_calling_analyst=7,
